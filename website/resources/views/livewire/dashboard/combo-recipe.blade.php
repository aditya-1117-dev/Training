<div>
    @livewire('dashboard.components.page-title', ['title' => 'Combo Recipe'])
    <div class="row mb-3">
        <div class="col-12  d-flex justify-content-end">
            ...
            data-bs-target="#addrecipe">New</button>
        </div>
    </div>
    <div class="row mb-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-end">
                            @if (auth()->user()->role == 0)
                                ...
                                <!--  <button wire:click='editIngredent({{$item->id}})' class="btn btn-primary" > Ingd</button>-->
                                <!--   <button wire:click='editDirection({{$item->id}})' class="btn btn-primary" > Dirc</button>-->
                                <!--    <button wire:click='editInstruction({{$item->id}})' class="btn btn-primary" > Ins</button>-->
